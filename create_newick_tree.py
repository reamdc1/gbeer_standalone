...
def check_options(parsed_args):
    ...
    return genbank_directory, outfolder, filter_file, marker_gene, tree_file
...
def main():
    ...
    genbank_directory, outfolder, filter_file, marker_gene, tree_file = check_options(parsed_args)
    ...
    #common_to_accession_dict = make_target_fasta(marker_gene, genbank_directory, filter_file, distmat_outfile)
    common_to_accession_dict = make_target_fasta(marker_gene, genbank_directory, filter_file, marker_fasta)
    
    
    #create_distmat(marker_fasta)

...
def check_options(parsed_args):
    ...
    return genbank_directory, outfolder, filter_file, num_proc, do_protein
...
def main():
    ...
    genbank_directory, outfolder, filter_file, num_proc, do_protein = check_options(parsed_args)

...
def check_options(parsed_args):
    ...
    if parsed_args.tree == 'NONE' or os.path.exists(parsed_args.tree):
        tree_file = parsed_args.filter
    else:
        print "The file %s does not exist." % parsed_args.tree
        sys.exit()
    ...
    return genbank_directory, gene_block_file, outfolder, filter_file, num_proc, min_genes, max_gap, e_val, tree_file
...
def main():
    ...
    genbank_directory, gene_block_file, outfolder, filter_file, num_proc, min_genes, max_gap, e_val, tree_file = check_options(parsed_args)
    
    #print genbank_directory, gene_block_file, outfolder, filter_file, num_proc, min_genes, max_gap, e_val
    print genbank_directory, gene_block_file, outfolder, filter_file, num_proc, min_genes, max_gap, e_val, tree_file

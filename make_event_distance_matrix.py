...
def parser_code():
    ...
    parser.add_argument("-i", "--gene_block_file", dest="gene_block_file", default='./regulonDB/operon_names_and_genes.txt', metavar="FILE",
    ...
    parser.add_argument("-o", "--outfolder", dest="outfolder", metavar="DIRECTORY", default='./operon_distance_matrices/',
                help="Folder where the results will be stored. Default is the folder './operon_distance_matrices/'.")
...
def check_options(parsed_args):
    ...
    return gene_block_file, infolder, outfolder, gene_block_filter, num_proc, max_gap
...
def main():
    ...
    gene_block_file, infolder, outfolder, gene_block_filter, num_proc, max_gap = check_options(parsed_args)
